###################################################################################################
#
#	Muscle extension script for Iniopera with a 3 degree starting gape, Dearden et al. 2022
#
###################################################################################################
...
output_file = open('../rpdearden/Documents/Manuscripts/2_Sub_or_In_rev/Iniopera_muscles/Resubmission_PNAS/Iniop_Resub_Analyses/2_Iniop_Gape/results_3deg/Iniopera_SF_output_3deg.txt', 'w')
...
while counter < (end + 1):
	...
	file_path = '../rpdearden/Documents/Manuscripts/2_Sub_or_In_rev/Iniopera_muscles/Resubmission_PNAS/Iniop_Resub_Analyses/2_Iniop_Gape/results_3deg/Stretch3deg_'
...
#RPD# Whack results back into file (path changed)
	output_file = open('../rpdearden/Documents/Manuscripts/2_Sub_or_In_rev/Iniopera_muscles/Resubmission_PNAS/Iniop_Resub_Analyses/2_Iniop_Gape/results_3deg/Iniopera_SF_output_3deg.txt', 'a')
