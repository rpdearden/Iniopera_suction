###################################################################################################
#
#	Muscle extension script for Iniopera - Modified from Lautenschlager (2015) by RPD
#
###################################################################################################
...
#ISSUES
####Think problem is starting from 0 rather than 3
###Struggling with degrees sign
###Not taking first 3 degrees worth of pics
...
output_file = open('../rpdearden/Documents/Manuscripts/2_Sub_or_In_rev/Iniopera_muscles/Resubmission_PNAS/Iniop_Resub_Analyses/2_Iniop_Gape/Iniopera_SF_output_9deg.txt', 'w')
...
while counter < (end + 1):
	...
	file_path = '../rpdearden/Documents/Manuscripts/2_Sub_or_In_rev/Iniopera_muscles/Resubmission_PNAS/Iniop_Resub_Analyses/2_Iniop_Gape/Stretch9_'
...
#RPD# Whack results back into file (path changed)
	output_file = open('../rpdearden/Documents/Manuscripts/2_Sub_or_In_rev/Iniopera_muscles/Resubmission_PNAS/Iniop_Resub_Analyses/2_Iniop_Gape/Iniopera_SF_output_9deg.txt', 'a')
