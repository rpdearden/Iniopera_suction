...
###For optimal gape of 56.5 degrees
...
#Name objects
Pharynx= bpy.data.objects['PharynxVol']
...
output_file = open('../rpdearden/Documents/Manuscripts/2_Sub_or_In_rev/Iniopera_muscles/Resubmission_PNAS/Iniop_Resub_Analyses/5_Iniop_Volume/Iniop_Vol_Max/InioperaSuctionMax_output.txt', 'w')
...
while counter < (end + 1):
    ...
    file_path = '../rpdearden/Documents/Manuscripts/2_Sub_or_In_rev/Iniopera_muscles/Resubmission_PNAS/Iniop_Resub_Analyses/5_Iniop_Volume/Iniop_Vol_Max/Iniop_Vol_Max'
    ...
    output_file = open('../rpdearden/Documents/Manuscripts/2_Sub_or_In_rev/Iniopera_muscles/Resubmission_PNAS/Iniop_Resub_Analyses/5_Iniop_Volume/Iniop_Vol_Max/InioperaSuctionMax_output.txt','a')
